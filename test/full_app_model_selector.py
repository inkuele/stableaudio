...
with gr.Blocks(title="🎵 Stable Audio Generator (Multi-Model)") as demo:
    gr.Markdown("## 🎵 Stable Audio Generator (with Model Selector)")
    gr.Markdown("Generate multiple clips from prompts. Supports fine-tuned models and stopping generation.")
